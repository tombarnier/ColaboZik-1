        ...
        <View style={{
          ...
          <View style={{
            width:ScreenWidth
              ...
              <TouchableOpacity onPress={() => this.nextMusic()}><Text style={{color:'#fff', padding:10,fontSize:15}}>Next</Text></TouchableOpacity>
              <TouchableOpacity onPress={() => this.prevMusic()}><Text style={{color:'#fff', padding:10,fontSize:15}}>Prev</Text></TouchableOpacity>
            </View>
        </View>
      </View>
    );
